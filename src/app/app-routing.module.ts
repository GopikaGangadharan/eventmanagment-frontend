...
const routes: Routes = [
  ...
  {
    path:'newborn-items',component:NewbornItemsComponent
  },
  {
    path:'newborn-add-items',component:NewbornAddItemsComponent
  },
  {
    path:'newborn-edit-items',component:NewbornEditItemsComponent
  },
  {
    path:'ceremony-items',component:CeremonyItemsComponent
  },
  {
    path:'ceremony-add-items',component:CeremonyAddItemsComponent
  },
  {
  ...
  // },
  {
   path:'bdaybooking',component:BdaybookingComponent
  },
  {
   path:'ceremonybooking',component:CeremonybookingComponent
  },
  {
    path:'newbornbooking',component:NewbornbookingComponent
  },
  {
